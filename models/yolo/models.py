...
from .utils import *
from .torch_utils import model_info as torch_utils_model_info 
from .torch_utils import fuse_conv_and_bn as torch_utils_fuse_conv_and_bn
...
class Darknet(nn.Module):
            ...
            if isinstance(a, nn.Sequential):
                for i, b in enumerate(a):
                    if isinstance(b, nn.modules.batchnorm.BatchNorm2d):
                        ...
                        conv = a[i - 1]
                        fused = torch_utils_fuse_conv_and_bn(conv, b)
    ...
    def info(self, verbose=False):
        torch_utils_model_info(self, verbose)
